    ...
    <div className="box">
      <form autoComplete="off">
        <div className="heading">
          <h1>{success ? "Payment Succesful" : " Embark on Your Yoga Journey: Admission Form for Transformative Wellness Classes"}</h1>
        </div>
        <div><i>Discover the Essence of Well-being: Embrace the Goodness of Yoga. Cultivate Balance, Harmony, and Strength. Nurture Your Body, Mind, and Soul. Join us on a Journey to Radiant Health and Inner Peace through the Transformative Power of Yoga...</i></div>
